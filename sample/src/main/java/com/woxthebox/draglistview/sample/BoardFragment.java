...
public class BoardFragment extends Fragment {
    ...
    public View onCreateView(LayoutInflater inflater, @Nullable ViewGroup container, @Nullable Bundle savedInstanceState) {
        ...
        mBoardView.setSwipeRefreshLayoutListener(new BoardView.ColumnsSwipeRefreshLayoutListener() {
            @Override
            public void onColumnRefresh(final SwipeRefreshLayout refreshLayout, int column) {

                Toast.makeText(getContext(), "Refresh column index: " + column , Toast.LENGTH_SHORT).show();

                doSomething(refreshLayout);
            }
        });
    ...
    private void doSomething(final SwipeRefreshLayout refreshLayout) {
        refreshLayout.postDelayed(new Runnable() {
            ...
            public void run() {
                ...
                int column = 4;
                int position = 5;
                mBoardView.scrollToPosition(column, position);
                Toast.makeText(getContext(), "scrollTo column: " + column + " position: " + position , Toast.LENGTH_SHORT).show();
